...
set XValue [lindex $argv 0]
Mac/RandomMacNew set numRetransmit XValue;
...
proc finish {} {
    ...
    #   Append tracer result to data file
    #	exec python3 tracer.py>>tableData &
        exit 0
}

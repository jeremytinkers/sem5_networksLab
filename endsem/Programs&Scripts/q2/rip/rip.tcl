...
proc finish {} {
        ...
        $ns flush-trace
        close $nf
	exec awk -f pdeliveryr.awk log.tr >plotPdrRip &
	exec awk -f avgDeliveryDelay.awk log.tr >plotAddRip  &
        exec awk -f lostPkts.awk log.tr >plotLpRip &
        exec awk -f throughput.awk log.tr >plotTRip  &
	exit 0
}
